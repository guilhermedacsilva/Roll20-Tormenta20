dbMagias = [{
    ...
    descricao: "Você manifesta e dispara uma adaga imaterial contra a mente do alvo, que sofre 2d6 pontos de dano psíquico e fica atordoado por uma rodada. Se passar no teste de resistência, sofre apenas metade do dano e evita a condição. Uma criatura só pode ficar atordoada por esta magia uma vez por cena.<br>+1 PM: você lança a magia sem gesticular ou pronunciar palavras (o que permite lançar esta magia de armadura) e a adaga se torna invisível. Se o alvo falhar no teste de resistência, não percebe que você lançou uma magia contra ele.<br>+2 PM: muda a duração para um dia. Além do normal, você “finca” a adaga na mente do alvo. Enquanto a magia durar, você sabe a direção e localização do alvo, desde que ele esteja no mesmo mundo.<br>+2 PM: aumenta o dano em +1d6."
}, {
    nome: "Alarme",
    tipo: "Arcana",
    circulo: 1,
    ...
    duracao: "instantânea",
    resistencia: "Vontade anula",
    descricao: "Você invade a mente do alvo e altera ou apaga suas memórias da última hora.<br>+2 PM: muda o alcance para pessoal e o alvo para área cone de 4,5m.<br>+5 PM: você pode alterar ou apagar as memórias das últimas 24 horas."
}, {
    ...
    descricao: "Três laços de energia surgem e se enroscam no alvo, deixando-o agarrado. A vítima pode tentar se livrar, gastando uma ação padrão para fazer um teste de Atletismo. Se passar, destrói um laço, mais um laço adicional para cada 5 pontos pelos quais superou a CD. Os laços também podem ser atacados e destruídos: cada um tem Defesa 10, 10 PV, RD 5 e imunidade a dano mágico. Se todos os laços forem destruídos, a magia é dissipada. Por serem feitos de energia, os laços afetam criaturas incorpóreas.<br>+2 PM: aumenta o número de alvos em +1.<br>+2 PM: aumenta o número de laços em um alvo a sua escolha em +1 (bônus máximo limitado pelo círculo máximo de magia que você pode lançar).<br>+3 PM: em vez do normal, cada laço é destruído automaticamente com um único ataque bem-sucedido; porém, cada laço destruído libera um choque de energia que causa 1d8+1 pontos de dano de essência na criatura amarrada. Requer 3º círculo."
}, {
    nome: "Amedrontar",
    tipo: "Arcana",
    circulo: 1,
    ...
    duracao: "cena",
    resistencia: "Vontade parcial",
    descricao: "O alvo é envolvido por energias sombrias e assustadoras. Se falhar na resistência, fica apavorado por 1 rodada, depois abalado. Se passar, fica abalado por 1d4 rodadas.<br>+2 PM: alvos que falhem na resistência ficam apavorados por 1d4+1 rodadas, em vez de apenas 1.<br>+2 PM: muda o alvo para 1 criatura.<br>+5 PM: afeta todos os alvos válidos a sua escolha dentro do alcance."
}, {
    ...
    duracao: "ver texto",
    descricao: "Esta magia cria uma onda de escuridão que causa diversos efeitos. Magias de até 3º círculo na área são dissipadas se você passar num teste de Religião contra a CD de cada uma. Seus aliados na área são protegidos por uma aura sombria e recebem +4 na Defesa até o fim da cena. Inimigos na área ficam enjoados por 1d4 rodadas (apenas uma vez por cena). Anular a Luz anula Dispersar as Trevas (este efeito tem duração instantânea).<br>+2 PM: aumenta o bônus na Defesa em +1.<br>+4 PM: muda as magias dissipadas para até 4º círculo. Requer 4º círculo.<br>+9 PM: muda as magias dissipadas para até 5º círculo. Requer 5º círculo."
}, {
    ...
    alvo: "você",
    duracao: "cena",
    descricao: "Você invoca a arma preferida de sua divindade (caso sua divindade possua uma), que surge flutuando a seu lado. Uma vez por rodada, quando você sofre um ataque corpo a corpo, pode usar uma reação para que a arma cause automaticamente 2d6 pontos de dano do tipo da arma — por exemplo, uma espada longa causa dano de corte — no oponente que fez o ataque. Esta magia se dissipa se você morrer.<br>+1 PM: além do normal, a arma o protege. Você recebe +1 na Defesa.<br>+2 PM: aumenta o bônus na Defesa em +1.<br>+2 PM: muda a duração para sustentada. Além do normal, uma vez por rodada, você pode gastar uma ação livre para fazer a arma acertar automaticamente um alvo adjacente. Se a arma atacar, não poderá contra-atacar até seu próximo turno. Requer 2º círculo.<br>+2 PM: muda o tipo do dano para essência. Requer 2º círculo.<br>+2 PM: aumenta o dano causado pela arma em +1d6 (bônus máximo limitado pelo círculo máximo de magia que você pode lançar).<br>+5 PM: invoca duas armas, permitindo que você contra-ataque (ou ataque, se usar o aprimoramento acima) duas vezes por rodada. Requer 3º círculo."
}, {
    nome: "Arma Mágica",
    tipo: "Universal",
    circulo: "1",
    ...
    duracao: "cena",
    descricao: "A arma é considerada mágica e fornece +1 nos testes de ataque e rolagens de dano (isso conta como um bônus de encanto). Caso você esteja empunhando a arma, pode usar seu atributo-chave de magias em vez do atributo original nos testes de ataque (não cumulativo com efeitos que somam este atributo).<br>+2 PM: aumenta o bônus em +1 (bônus máximo limitado pelo círculo máximo de magia que você pode lançar).<br>+2 PM: a arma causa +1d6 de dano de ácido, eletricidade, fogo ou frio, escolhido quando a magia é lançada. Este aprimoramento só pode ser usado uma vez.<br>+3 PM: muda o bônus de dano do aprimoramento acima para +2d6."
}, {
    ...
    alvo: "você",
    duracao: "cena",
    descricao: "Esta magia cria uma película protetora invisível, mas tangível, fornecendo +5 na Defesa. Esse bônus é cumulativo com outras magias, mas não com bônus fornecido por armaduras.<br>+1 PM: muda a execução para reação. Em vez do normal, você cria um escudo mágico que fornece +5 na Defesa contra o próximo ataque que sofrer (cumulativo com o bônus fornecido pelo efeito básico desta magia e armaduras).<br>+2 PM: aumenta o bônus na Defesa em +1.<br>+2 PM: muda a duração para um dia."
}, {
    ...
    duracao: "cena",
    descricao: "Você fortalece uma arma mundana primitiva (sem custo em T$, como bordão, clava, funda ou tacape), uma arma natural ou um ataque desarmado. O dano da arma aumenta em um passo e ela é considerada mágica. Ao lançar a magia, você pode mudar o tipo de dano da arma (escolhendo entre corte, impacto ou perfuração).<br>+1 PM: fornece +1 nos testes de ataque com a arma.<br>+2 PM: muda a execução para ação de movimento.<br>+3 PM: aumenta o bônus nos testes de ataque em +1.<br>+5 PM: aumenta o dano da arma em mais um passo."
}, {
    ...
    duracao: "cena",
    resistencia: "Vontade parcial",
    descricao: "Você se torna um conduíte da energia de sua divindade, emanando uma aura brilhante. Você e aliados devotos da mesma divindade ficam imunes a encantamento e recebem +10 na Defesa e em testes de resistência. Aliados não devotos da mesma divindade recebem +5 na Defesa e em testes de resistência. Além disso, inimigos que entrem na área devem fazer um teste de Vontade; em caso de falha, recebem uma condição a sua escolha entre esmorecido, debilitado ou lento até o fim da cena. O teste deve ser refeito cada vez que a criatura entrar novamente na área.<br>+2 PM: aumenta os bônus na Defesa e em testes de resistência em +1."
}, {
    nome: "Aviso",
    tipo: "Universal",
    circulo: "1",
    ...
    alvo: "aliados",
    duracao: "cena",
    descricao: "Abençoa seus aliados, que recebem +1 em testes de ataque e rolagens de dano. Bênção anula Perdição.<br>+1 PM: muda o alvo para 1 cadáver e a duração para 1 semana. O cadáver não se decompõe nem pode ser transformado em morto-vivo.<br>+2 PM: aumenta os bônus em +1 (bônus máximo limitado pelo círculo máximo de magia que você pode lançar)."
}, {
    nome: "Bola de Fogo",
    tipo: "Arcana",
    circulo: 2,
    ...
    alvo: "você",
    duracao: "cena",
    descricao: "Esta magia cria uma película protetora sobre você. Você recebe 30 pontos de vida temporários.<br>+1 PM: muda a execução para reação e a duração para instantânea. Em vez do normal, você recebe RD 30 contra o próximo dano que sofrer.<br>+3 PM: muda os PV temporários ou a RD para 50. Requer 3º círculo.<br>+7 PM: muda os PV temporários ou a RD para 70. Requer 4º círculo.<br>+7 PM: muda o alcance para curto, o alvo para outra criatura ou objeto Enorme ou menor e a duração para sustentada. Em vez do normal, cria uma esfera imóvel e tremeluzente ao redor do alvo. Nenhuma criatura, objeto ou efeito de dano pode passar pela esfera, embora criaturas possam respirar normalmente. Criaturas na área podem fazer um teste de Reflexos para evitar serem aprisionadas e sempre que você se concentrar. Requer 4º círculo.<br>+9 PM: como o aprimoramento acima, mas tudo dentro da esfera fica praticamente sem peso. Uma vez por rodada, você pode gastar uma ação livre para flutuar a esfera e seu conteúdo 9m em uma direção. Requer 4º círculo."
}, {
    ...
    alvo: "1 criatura",
    duracao: "cena",
    descricao: "O alvo fica com sua imagem nublada, como se vista através de um líquido, recebendo os efeitos de camuflagem leve.<br>+3 PM: muda a duração para sustentada. A imagem do alvo fica mais distorcida, aumentando a chance de falha da camuflagem leve para 50%.<br>+7 PM: muda o alcance para curto e o alvo para criaturas escolhidas. Requer 4º círculo."
}, {
    ...
    duracao: "cena",
    descricao: "Pela duração da magia, você sabe a posição e status (PV atuais, se estão com uma condição ou sob efeito de magia...) dos alvos. Depois de lançada, a distância dos alvos não importa — a magia só deixa de detectar um alvo se ele morrer ou for para outro plano.<br>+1 PM: aumenta o número de alvos em +1.<br>+1 PM: muda a duração para um dia."
}, {
    ...
    duracao: "4d12 horas",
    descricao: "Você muda o clima da área onde se encontra, podendo criar qualquer condição climática: chuva, neve, ventos, névoas... Veja o Capítulo 6: O Mestre para os efeitos do clima. + 1 PM(Apenas Druidas): muda o raio da área para 3km e duração para 1d4 dias."
}, {
    ...
    duracao: "instantânea",
    resistencia: "Fortitude parcial",
    descricao: "Esta magia cria um crânio envolto em energia negativa. Quando atinge o alvo, ele causa 4d8 + 4 pontos de dano de trevas e se desfaz emitindo um som horrendo, deixando abalado o alvo e todos os inimigos num raio de 3m dele(criaturas já abaladas ficam apavoradas por 1d4 rodadas). Passar no teste de resistência diminui o dano à metade e evita a condição(as demais criaturas na área também tem direito ao teste de resistência, para evitar a condição).<br>+2 PM: aumenta o dano em + 1d8 + 1.<br>+2 PM: aumenta o número de alvos em + 1."
}, {
    ...
    duracao: "cena, até ser descarregada",
    descricao: "Você recebe uma intuição aguçada sobre perigos ao seu redor. Quando uma criatura hostil ou armadilha entra na área do efeito, você faz um teste de Percepção(CD determinada pelo mestre de acordo com a situação). Se passar, sabe a origem(criatura ou armadilha), direção e distância do perigo. Se falhar, sabe apenas que o perigo existe.<br>+1 PM: você descobre também a raça ou espécie e o poder da criatura detectada(determinado pela aura dela). Criaturas de 1º a 6º nível ou ND geram aura tênue, criaturas de 7º a 12º nível ou ND geram aura moderada e criaturas de 13º ao 20º nível ou ND geram aura poderosa. Criaturas acima do 20º nível ou ND geram aura avassaladora.<br>+2 PM: além do normal, você não fica surpreso desprevenido contra perigos detectados com sucesso e recebe + 5 em testes de resistência contra armadilhas. Requer 2º círculo."
}, {
    ...
    descricao: "Um leque de chamas irrompe de suas mãos, causando 2d6 pontos de dano de fogo às criaturas na área.<br>Truque: muda o alcance para curto, a área para alvo de 1 objeto e a resistência para Reflexos anula. Você gera uma pequena explosão que não causa dano mas pode acender uma vela, tocha ou fogueira. Também pode fazer um objeto inflamável com RD 0(como uma corda ou pergaminho) ficar em chamas. Uma criatura em posse de um objeto pode evitar esse efeito se passar no teste de resistência.<br>+1 PM: aumenta o dano em + 1d6.<br>+1 PM: muda a resistência para Reflexos parcial. Se passar, a criatura reduz o dano à metade; se falhar, fica em chamas(veja Condições, na página 394)."
}, {
    nome: "Ferver Sangue",
    tipo: "Arcana",
    circulo: 3,
    ...
    alvo: "1 criatura",
    duracao: "cena",
    descricao: "Você fortalece o corpo do alvo. Ele recebe + 2 em Força, Destreza ou Constituição, a sua escolha. Esse aumento não oferece PV ou PM adicionais.<br>+3 PM: muda o alcance para curto e o alvo para criaturas escolhidas.<br>+3 PM: em vez do normal, o alvo recebe + 2 nos três atributos físicos. Requer 3º círculo.<br>+7 PM: em vez do normal, o alvo recebe + 4 no atributo escolhido. Requer 4º círculo.<br>+12 PM: em vez do normal, o alvo recebe + 4 nos três atributos físicos. Requer 5º círculo."
}, {
    nome: "Flecha Ácida",
    tipo: "Arcana",
    circulo: 2,
    ...
    duracao: "instantânea",
    resistencia: "Reflexos parcial",
    descricao: "Você dispara um projétil que causa 4d6 pontos de dano de ácido. Se falhar no teste de resistência, o alvo fica coberto por um muco corrosivo, sofrendo mais 2d6 de dano de ácido no início de seus dois próximos turnos. Se lançada contra um objeto que não esteja em posse de uma criatura a magia causa dano dobrado e ignora a RD do objeto.<br>+1 PM: além do normal, se o alvo coberto pelo muco ácido estiver usando armadura ou escudo, o item é corroído. Isso reduz o bônus na Defesa do item em 1 ponto permanentemente. O item pode ser consertado, restaurando seu bônus(veja Ofício, na página 121).<br>+2 PM: aumenta a redução na Defesa em + 1.<br>+2 PM: aumenta o dano inicial e o dano por rodada em + 1d6."
}, {
    nome: "Forma Etérea",
    tipo: "Arcana",
    circulo: 4,
    ...
    alvo: "1 criatura",
    duracao: "cena",
    descricao: "Esta magia imbui uma criatura com coragem e valentia. O alvo fica imune a medo e recebe 40 PV temporários e + 4 em testes de ataque e rolagens de dano contra o inimigo de maior ND na cena.<br>+2 PM: muda o bônus para + 6."
}, {
    nome: "Hipnotismo",
    tipo: "Arcana",
    circulo: 1,
    ...
    duracao: "1d4 rodadas",
    resistencia: "Vontade anula",
    descricao: "Suas palavras e movimentos ritmados deixam o alvo fascinado. Esta magia só afeta criaturas que possam perceber você. Se usar esta magia em combate, o alvo recebe + 5 em seu teste de resistência. Se a criatura passar, fica imune a este efeito por um dia.<br>Truque: muda a duração para 1 rodada. Em vez de fascinado, o alvo fica pasmo(apenas uma vez por cena).<br>+1 PM: como o normal, mas alvos que passem na resistência não sabem que foram vítimas de uma magia.<br>+2 PM: muda o alvo para animais ou humanoides escolhidos.<br>+2 PM: muda a duração para sustentada.<br>+2 PM: também afeta espíritos e monstros na área. Requer 2º círculo.<br>+5 PM: também afeta construtos, espíritos, monstros e mortos - vivos na área. Requer 3º círculo."
}, {
    ...
    duracao: "instantânea",
    resistencia: "Vontade parcial",
    descricao: "Um cone de luzes brilhantes surge das suas mãos, deixando os animais e humanoides na área atordoados por 1 rodada(apenas uma vez por cena, Vontade anula) e ofuscados pela cena.<br>+2 PM: além do normal, as criaturas afetadas ficam vulneráveis pela cena.<br>+2 PM: também afeta espíritos e monstros na área. Requer 2º círculo.<br>+5 PM: também afeta construtos, espíritos, monstros e mortos - vivos na área. Requer 3º círculo."
}, {
    nome: "Libertação",
    tipo: "Universal",
    circulo: "4",
...
},
{
    ...
    alvo: "você",
    duracao: "sustentada",
    descricao: "Você fica coberto por um manto de energia sombria. Nesta forma, torna-se incorpóreo (inclui seu equipamento): só pode ser afetado por armas e habilidades mágicas, ou por outras criaturas incorpóreas, e pode atravessar objetos sólidos, mas não manipulá-los. Também não pode atacar criaturas normais (mas ainda pode lançar magias nelas). Além disso, se torna vulnerável à luz direta: se exposto a uma fonte de luz, sofre 1 ponto de dano por rodada. Você pode gastar uma ação de movimento e 1 PM para “entrar” em uma sombra do seu tamanho ou maior e se teletransportar para outra sombra, também do seu tamanho ou maior, em alcance médio.<br>+4 PM: muda o alcance para toque e o alvo para 1 criatura. Requer 4º círculo."
}, {
    ...
    alvo: "1 criatura",
    duracao: "cena",
    descricao: "Você fortalece a mente do alvo. Ele recebe +2 em Inteligência, Sabedoria ou Carisma, a sua escolha. Esse aumento não oferece PV, PM ou perícias adicionais.<br>+3 PM: muda o alcance para curto e o alvo para criaturas escolhidas.<br>+3 PM: em vez do normal, o alvo recebe +2 nos três atributos mentais. Requer 3º círculo.<br>+7 PM: em vez do normal, o alvo recebe +4 no atributo escolhido. Requer 4º círculo.<br>+12 PM: em vez do normal, o alvo recebe +4 nos três atributos mentais. Requer 5º círculo."
}, {
    nome: "Metamorfose",
    tipo: "Arcana",
    circulo: 2,
    ...
    duracao: "1 dia",
    descricao: "Esta magia convoca um parceiro cavalo (ou pônei) de guerra veterano. Sua aparência é de um animal negro com crina e cauda cinzentas e cascos feitos de fumaça, mas você pode mudá-la se quiser. Além dos benefícios normais, a Montaria Arcana pode atravessar terreno difícil sem redução em seu deslocamento. Você pode usar Misticismo no lugar de Cavalgar para efeitos desta montaria (incluindo ser considerado treinado).<br>+1 PM: além do normal, criaturas do tipo animal em alcance curto da montaria devem fazer um teste de Vontade. Se passarem, ficam abaladas pela cena; se falharem, ficam apavoradas por 1d4 rodadas, depois abaladas pela cena.<br>+3 PM: muda a duração para permanente e adiciona penalidade de –3 PM.<br>+3 PM: aumenta o tamanho da montaria em uma categoria. Isso também aumenta o número de criaturas que ela pode carregar — duas para uma criatura Enorme, seis para Colossal. Uma única criatura controla a montaria; as outras apenas são deslocadas.<br>+3 PM: muda o nível do parceiro para mestre. Requer 3º círculo."
}, {
    ...
    duracao: "sustentada",
    descricao: "Você e os seus aliados no alcance recebem +2 em testes de perícia e rolagens de dano, e todos os seus inimigos no alcance sofrem –2 em testes de perícia e rolagens de dano. Esse efeito é cumulativo com outras magias. Componente material: T$ 25 por PM gasto em incensos ou outras oferendas.<br>+2 PM: aumenta os bônus em +1 (bônus máximo limitado pelo círculo máximo de magia que você pode lançar).<br>+2 PM: aumenta as penalidades em –1 (penalidade máxima limitada pelo círculo máximo de magia que você pode lançar).<br>+7 PM: muda o alcance para médio. Requer 3º círculo.<br>+12 PM: muda a duração para cena. Requer 4º círculo."
}, {
    nome: "Orientação",
    tipo: "Divina",
    circulo: 1,
    ...
    alvo: "1 criatura",
    duracao: "1 rodada",
    descricao: "Em seu próximo teste de perícia, o alvo pode rolar dois dados e ficar com o melhor resultado.<br>+2 PM: muda a duração para cena. Em vez do normal, escolha um atributo. Sempre que o alvo fizer um teste de perícia baseado no atributo escolhido, pode rolar dois dados e ficar com o melhor resultado. Não se aplica a testes de ataque ou resistência. Requer 2º círculo.<br>+5 PM: como acima, mas, em vez de um atributo, escolha entre atributos físicos (Força, Destreza e Constituição) ou mentais (Inteligência, Sabedoria e Carisma). Requer 3º círculo.<br>+5 PM: muda o alvo para criaturas escolhidas. Requer 3º círculo."
}, {
    ...
    duracao: "cena",
    resistencia: "nenhuma",
    descricao: "Amaldiçoa os alvos, que recebem –1 em testes de ataque e rolagens de dano. Perdição anula Bênção.<br>+2 PM: aumenta as penalidades em –1 (bônus máximo limitado pelo círculo máximo de magia que você pode lançar)."
}, {
    ...
    duracao: "cena",
    resistencia: "Fortitude (veja texto)",
    descricao: "Você manifesta uma nuvem de poeira carregada de energia negativa, que apodrece lentamente as criaturas na área. Ao lançar a magia, e no início de seus turnos, criaturas na área sofrem 2d8+8 pontos de dano de trevas (Fortitude reduz à metade). Alvos que falharem no teste não podem recuperar PV por uma rodada.<br>+2 PM: aumenta o dano em 1d8+4."
}, {
    nome: "Possessão",
    tipo: "Arcana",
    circulo: 5,
    ...
    alvo: "1 criatura",
    duracao: "instantânea",
    descricao: "Você purifica a criatura tocada, removendo uma condição dela entre abalado, apavorado, alquebrado, atordoado, cego, confuso, debilitado, enjoado, envenenado, esmorecido, exausto, fascinado, fatigado, fraco, frustrado, lento, ofuscado, paralisado, pasmo ou surdo.<br>+2 PM: também recupera todos os PV perdidos por veneno.<br>+2 PM: em vez de uma, remove todas as condições listadas.<br>+3 PM: também permite que o alvo solte qualquer item amaldiçoado que esteja segurando (mas não remove a maldição do item em si).<br>+7 PM: também dissipa magias e efeitos prejudiciais de encantamento, necromancia e transmutação afetando o alvo. Requer 3º círculo."
}, {
    nome: "Queda Suave",
    tipo: "Arcana",
    circulo: 1,
    ...
    duracao: "instantânea",
    resistencia: "Fortitude parcial",
    descricao: "Você dispara um raio azul esbranquiçado de gelo e ar congelante. O alvo sofre 10d8 pontos de dano de frio e fica preso em um bloco de gelo (paralisado). Se passar no teste de resistência, sofre metade do dano e, em vez de paralisado, fica lento por uma rodada. É possível quebrar o gelo para libertar uma criatura presa: o bloco tem 20 PV, RD 10 e é vulnerável a fogo. Uma criatura presa pode gastar uma ação completa para fazer um teste de Atletismo e se libertar do gelo; cada vez que passar no teste causa 10 pontos de dano ao bloco, ignorando a RD.<br>+3 PM: aumenta o dano em +2d8.<br>+5 PM: muda o alvo para área de esfera com 6m de raio. Em vez de um raio, você dispara uma bola de gelo que explode, causando o efeito da magia em todas as criaturas na área."
}, {
    nome: "Raio Solar",
    tipo: "Divina",
    circulo: 2,
    ...
    alvo: "1 criatura",
    duracao: "cena",
    descricao: "Ao lançar esta magia, escolha entre ácido, eletricidade, fogo, frio, luz ou trevas. O alvo recebe redução de dano 10 contra o tipo de dano escolhido.<br>+2 PM: aumenta a redução de dano em +5.<br>+2 PM: muda a duração para um dia. Requer 2º círculo.<br>+5 PM: muda o alcance para curto e o alvo para criaturas escolhidas. Requer 3º círculo.<br>+5 PM: muda o efeito para redução de dano contra todos os tipos listados na magia. Requer 3º círculo.<br>+9 PM: muda o efeito para imunidade a um tipo listado na magia. Requer 4º círculo."
}, {
    nome: "Rogar Maldição",
    tipo: "Divina",
    circulo: 2,
    ...
    execucao: "padrão",
    alcance: "longo",
    alvo: "Efeito: criaturas conjuradas",
    duracao: "1 cena",
    ...
    duracao: "instantânea",
    resistencia: "Fortitude parcial",
    descricao: "Ninguém sabe se Mestre Arsenal foi realmente o criador desta magia — mas ele foi o primeiro a utilizá-la. Você fecha o punho e gesticula como se estivesse golpeando o alvo, causando dano de impacto igual a 4d6 + sua Força. A vítima é empurrada 3m na direção oposta à sua. Passar no teste de resistência reduz o dano à metade e evita o empurrão.<br>+1 PM: muda o alcance para pessoal, o alvo para você, a duração para cena e a resistência para nenhuma. Em vez do normal, seus ataques corpo a corpo passam a acertar inimigos distantes. Seu alcance natural aumenta em 3m; uma criatura Média pode atacar adversários a até 4,5m, por exemplo.<br>+2 PM: aumenta o dano em +1d6.<br>+4 PM: aumenta o empurrão em +3m.<br>+5 PM: muda o tipo do dano para essência."
}, {
    ...
    alvo: "1 criatura",
    duracao: "1 dia",
    descricao: "Esta magia facilita a sobrevivência em ambientes hostis. O alvo fica imune aos efeitos de calor e frio extremos, pode respirar na água se respirar ar (ou vice-versa) e não sufoca em fumaça densa.<br>+5 PM: muda o alcance para curto e o alvo para criaturas escolhidas."
}, {
    ...
    duracao: "cena",
    resistencia: "Reflexos anula",
    descricao: "Teia cria várias camadas de fibras entrelaçadas e pegajosas na área. Qualquer criatura na área que falhar na resistência fica enredada. Uma vítima pode se libertar com uma ação padrão e um teste de Acrobacia ou Atletismo. A área ocupada por Teia é terreno difícil. A Teia é inflamável. Qualquer ataque que cause dano de fogo destrói as teias por onde passar, libertando as criaturas enredadas mas deixando-as em chamas.<br>+1 PM: além do normal, criaturas que falhem na resistência também ficam imóveis.<br>+2 PM: além do normal, no início de seus turnos a magia afeta novamente qualquer criatura na área, exigindo um novo teste de Reflexos. Requer 2º círculo.<br>+2 PM: aumenta a área em +1 cubo de 1,5m."
}, {
    nome: "Telecinesia",
    tipo: "Arcana",
    circulo: 3,
    ...
    duracao: "sustentada",
    descricao: "Esta magia só pode ser usada em ambientes abertos. A área fica sujeita a um vendaval — ataques à distância sofrem penalidade de –5, chamas são apagadas e névoas são dissipadas. Você também pode gerar chuva(–5 em testes de Percepção), neve(como chuva, e a área se torna terreno difícil) ou granizo(como chuva, mais 1 ponto de dano de impacto por rodada, no início de seus turnos).<br>+1 PM: além do normal, uma vez por rodada você pode gastar uma ação padrão para fazer um raio cair sobre um alvo na área, causando 3d8 pontos de dano de eletricidade(Reflexos reduz à metade).<br>+2 PM: aumenta o dano de raios(veja acima) em + 1d8.<br>+3 PM: se escolheu causar chuva, ela se torna mais grossa, revelando a silhueta de criaturas invisíveis na área. Criaturas Médias ou menores ficam lentas e criaturas voadoras precisam passar num teste de Atletismo por rodada ou caem ao solo(mas podem fazer testes de Acrobacia para reduzir o dano de queda, como o normal).<br>+3 PM: se escolheu causar granizo, muda o dano para 2d6 por rodada.<br>+3 PM: se escolheu causar neve, criaturas na área sofrem 2d6 pontos de dano de frio no início de seus turnos.<br>+3 PM: muda a área para cilindro com 90m de raio e 90m de altura."
}, {
    ...
    descricao: "Arcos elétricos envolvem sua mão, causando 2d8 + 2 pontos de dano de eletricidade. Se o alvo usa armadura de metal(ou carrega muito metal, a critério do mestre), sofre uma penalidade de –5 no teste de resistência.<br>+1 PM: aumenta o dano em 1d8 + 1.<br>+2 PM: muda a resistências para nenhum. Como parte da execução da magia, você faz um ataque corpo a corpo contra o alvo. Se acertar, causa o dano do ataque e da magia.<br>+2 PM: muda o alcance para pessoal e o alvo para área: esfera com 6m de raio. Você dispara raios pelas pontas dos dedos que afetam todas as criaturas na área."
}, {
    nome: "Toque da Morte",
    tipo: "Universal",
    circulo: "5",
    ...
    alvo: "1 criatura",
    duracao: "sustentada",
    descricao: "O alvo pode realizar uma ação padrão ou de movimento adicional por turno. Esta ação não pode ser usada para lançar magias e ativar engenhocas.<br>+0 PM: muda a duração para cena. A ação adicional que você pode fazer é apenas de movimento. Uma criatura só pode receber uma ação adicional por turno como efeito de Velocidade.<br>+7 PM: muda o alvo para criaturas escolhidas no alcance. Requer 4º círculo.<br>+7 PM: muda o alcance para pessoal e o alvo para você. Você acelera sua mente, além de seu corpo. A ação adicional pode ser usada para lançar magias e ativar engenhocas. Requer 4º círculo."
}, {
    ...
    duracao: "1 dia",
    descricao: "Você fortalece um item, aumentando o bônus de Defesa de uma armadura ou escudo em + 2. No caso de um vestuário, ele passa a oferecer + 2 na Defesa(não cumulativo com armadura). Os efeitos desta magia contam como um bônus de encanto.<br>+3 PM: o objeto oferece o mesmo bônus em testes de resistência. Requer 3º círculo.<br>+4 PM: aumenta o bônus em + 1.<br>+7 PM: o objeto também oferece redução de dano 5. Requer 4º círculo."
}, {
    nome: "Viagem Arbórea",
    tipo: "Divina",
    circulo: 3,
