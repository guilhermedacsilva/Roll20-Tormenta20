dbMagias = [{
    ...
    duracao: "cena, até ser descarregada",
    descricao: "Você recebe uma intuição aguçada sobre perigos ao seu redor. Quando uma criatura hostil ou armadilha entra na área do efeito, você faz um teste de Percepção(CD determinada pelo mestre de acordo com a situação). Se passar, sabe a origem(criatura ou armadilha), direção e distância do perigo. Se falhar, sabe apenas que o perigo existe. + 1 PM: você descobre também a raça ou espécie e o poder da criatura detectada(determinado pela aura dela). Criaturas de 1º a 6º nível ou ND geram aura tênue, criaturas de 7º a 12º nível ou ND geram aura moderada e criaturas de 13º ao 20º nível ou ND geram aura poderosa. Criaturas acima do 20º nível ou ND geram aura avassaladora. + 2 PM: além do normal, você não fica surpreso desprevenido contra perigos detectados com sucesso e recebe + 5 em testes de resistência contra armadilhas. Requer 2º círculo."
}, {
    ...
    alvo: "esfera com 6m de raio",
    duracao: "veja texto",
    descricao: "Esta magia cria um forte brilho(multicolorido ou de uma cor que remeta a sua divindade) que causa diversos efeitos. Todas as magias de 3º círculo ou menor ativas na área são dissipadas se você passar num teste de Religião contra a CD de cada magia. Seus aliados na área recebem + 4 em testes de resistência e redução de trevas 10 até o fim da cena, protegidos por uma aura sutil da mesma cor. Inimigos na área ficam cegos por 1d4 rodadas(apenas uma vez por cena). Dispersar as Trevas anula Anular a Luz(este efeito tem duração instantânea). + 2 PM: aumenta o bônus nas resistências em + 1. + 4 PM: muda o alcance para curto, a área para alvo 1 criatura e a duração para cena. O alvo fica imune a efeitos de trevas. + 4 PM: muda o círculo máximo de magias dissipadas para 4º. Requer 4º círculo. + 9 PM: muda o círculo máximo de magias dissipadas para 5º. Requer 5º círculo."
}, {
    nome: "Dissipar Magia",
    tipo: "Universal",
    circulo: "2",
    ...
    descricao: "Um leque de chamas irrompe de suas mãos, causando 2d6 pontos de dano de fogo às criaturas na área.<br>Truque: muda o alcance para curto, a área para alvo de 1 objeto e a resistência para Reflexos anula. Você gera uma pequena explosão que não causa dano mas pode acender uma vela, tocha ou fogueira. Também pode fazer um objeto inflamável com RD 0(como uma corda ou pergaminho) ficar em chamas. Uma criatura em posse de um objeto pode evitar esse efeito se passar no teste de resistência. + 1 PM: aumenta o dano em + 1d6. + 1 PM: muda a resistência para Reflexos parcial. Se passar, a criatura reduz o dano à metade; se falhar, fica em chamas(veja Condições, na página 394)."
}, {
    nome: "Ferver Sangue",
    tipo: "Arcana",
    circulo: 3,
    ...
    alvo: "1 criatura",
    duracao: "cena",
    descricao: "Você fortalece o corpo do alvo. Ele recebe + 2 em Força, Destreza ou Constituição, a sua escolha. Esse aumento não oferece PV ou PM adicionais. + 3 PM: muda o alcance para curto e o alvo para criaturas escolhidas. + 3 PM: em vez do normal, o alvo recebe + 2 nos três atributos físicos. Requer 3º círculo. + 7 PM: em vez do normal, o alvo recebe + 4 no atributo escolhido. Requer 4º círculo. + 12 PM: em vez do normal, o alvo recebe + 4 nos três atributos físicos. Requer 5º círculo."
}, {
    nome: "Flecha Ácida",
    tipo: "Arcana",
    circulo: 2,
    ...
    alvo: "1 criatura",
    duracao: "cena",
    descricao: "Esta magia imbui uma criatura com coragem e valentia. O alvo fica imune a medo e recebe 40 PV temporários e + 4 em testes de ataque e rolagens de dano contra o inimigo de maior ND na cena. + 2 PM: muda o bônus para + 6."
}, {
    nome: "Hipnotismo",
    tipo: "Arcana",
    circulo: 1,
    ...
    duracao: "cena",
    resistencia: "Vontade parcial",
    descricao: "O alvo fica paralisado; se passar na resistência, em vez disso fica lento. A cada rodada, pode gastar uma ação completa para fazer um novo teste de Vontade. Se passar, se liberta do efeito. + 1 PM: muda o alvo para 1 espírito. + 2 PM: aumenta o número de alvos em + 1. + 3 PM: muda o alvo para 1 criatura. Requer 4º círculo."
}, {
    ...
    duracao: "instantânea",
    resistencia: "Fortitude reduz à metade",
    descricao: "Você canaliza energia negativa contra um alvo, causando 2d8 + 2 pontos de dano de trevas(ou curando 2d8 + 2 PV, se for um morto - vivo). Infligir Ferimentos anula Curar Ferimentos. + 1 PM: além do normal, se falhar na resistência, o alvo fica fraco pela cena. + 2 PM: aumenta o dano em 1d8 + 1. + 2 PM: muda a resistência para nenhum. Como parte da execução da magia, você pode fazer um ataque corpo a corpo contra o alvo. Se acertar, causa o dano do ataque e o efeito da magia. + 5 PM: muda o alcance para curto e o alvo para criaturas escolhidas."
}, {
    ...
    duracao: "instantânea",
    resistencia: "Vontade parcial",
    descricao: "Um cone de luzes brilhantes surge das suas mãos, deixando os animais e humanoides na área atordoados por 1 rodada(apenas uma vez por cena, Vontade anula) e ofuscados pela cena. + 2 PM: além do normal, as criaturas afetadas ficam vulneráveis pela cena. + 2 PM: também afeta espíritos e monstros na área. Requer 2º círculo. + 5 PM: também afeta construtos, espíritos, monstros e mortos - vivos na área. Requer 3º círculo."
}, {
    nome: "Libertação",
    tipo: "Universal",
    circulo: "4",
...
},
{
    ...
    descricao: "Arcos elétricos envolvem sua mão, causando 2d8 + 2 pontos de dano de eletricidade. Se o alvo usa armadura de metal(ou carrega muito metal, a critério do mestre), sofre uma penalidade de –5 no teste de resistência. + 1 PM: aumenta o dano em 1d8 + 1. + 2 PM: muda a resistências para nenhum. Como parte da execução da magia, você faz um ataque corpo a corpo contra o alvo. Se acertar, causa o dano do ataque e da magia. + 2 PM: muda o alcance para pessoal e o alvo para área: esfera com 6m de raio. Você dispara raios pelas pontas dos dedos que afetam todas as criaturas na área."
}, {
    nome: "Toque da Morte",
    tipo: "Universal",
    circulo: "5",
    ...
    alvo: "1 criatura",
    duracao: "sustentada",
    descricao: "O alvo pode realizar uma ação padrão ou de movimento adicional por turno. Esta ação não pode ser usada para lançar magias e ativar engenhocas. + 0 PM: muda a duração para cena. A ação adicional que você pode fazer é apenas de movimento. Uma criatura só pode receber uma ação adicional por turno como efeito de Velocidade. + 7 PM: muda o alvo para criaturas escolhidas no alcance. Requer 4º círculo. + 7 PM: muda o alcance para pessoal e o alvo para você. Você acelera sua mente, além de seu corpo. A ação adicional pode ser usada para lançar magias e ativar engenhocas. Requer 4º círculo."
}, {
    ...
    duracao: "1 dia",
    descricao: "Você fortalece um item, aumentando o bônus de Defesa de uma armadura ou escudo em + 2. No caso de um vestuário, ele passa a oferecer + 2 na Defesa(não cumulativo com armadura). Os efeitos desta magia contam como um bônus de encanto. + 3 PM: o objeto oferece o mesmo bônus em testes de resistência. Requer 3º círculo. + 4 PM: aumenta o bônus em + 1. + 7 PM: o objeto também oferece redução de dano 5. Requer 4º círculo."
}, {
    nome: "Viagem Arbórea",
    tipo: "Divina",
    circulo: 3,
